...
class Test(engine.Engine):
    r"""Test Softmax-loss engine for image-reid.
    ...
    def __init__(self, datamanager, model, optimizer, scheduler=None, use_gpu=True,
                 label_smooth=True):
        super(Test, self).__init__(datamanager, model, optimizer, scheduler, use_gpu)
    ...
    def train(self, epoch, max_epoch, trainloader, fixbase_epoch=0, open_layers=None, print_freq=10):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            if self.writer is not None:
                ...
                self.writer.add_scalar('Train/Base_Loss', base_losses.avg, n_iter)
                #self.writer.add_scalar('Train/My_Loss', my_losses.avg, n_iter)
                self.writer.add_scalar('Train/Density_loss', density_losses.avg, n_iter)
